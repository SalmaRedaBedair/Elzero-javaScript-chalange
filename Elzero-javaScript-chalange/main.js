...
let len=document.createElement("link");
len.href="https://fonts.googleapis.com/css2?family=Work+Sans:ital,wght@0,300;0,500;0,600;0,700;0,800;1,100&display=swap";
len.rel="stylesheet";
...
myH2.style.fontWeight="10px";
myH2.style.letterSpacing="1px";
...
//myHeader.style.justifyContent="center";
...
myLink1.style.fontSize="10px";
myLink2.style.fontSize="10px";
myLink3.style.fontSize="10px";
myLink4.style.fontSize="10px";
myLink1.style.color="rgb(216 216 216 / 70%)";
myLink2.style.color="rgb(216 216 216 / 70%)";
myLink3.style.color="rgb(216 216 216 / 70%)";
myLink4.style.color="rgb(216 216 216 / 70%)";
...
for (let i = 1; i <= 15; i++) {
    ...
    par.style.color="rgb(216 216 216 / 70%)";
